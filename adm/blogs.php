...
.fluid a:last-child {
  margin-right: 0rem;
   ...
   <h5 class='mb-3'>Blogs Management</h5>
                ...
                <a href="addblog" type="button" class="btn btn-primary m-2">Add blog</a>
...
<?php
 ...
 $sql="select * from potblog order by id desc";
...
if ($file_t=='mp4') {
  ...
  <div class="col-sm-4 mb-2">
    <div class="card">
      <div class="card-body">
      <img class="card-img-top" style="display:<?php echo $img ?>;"  src="uploadblog/<?php echo  $row['image'];?>" alt="Card image cap">
